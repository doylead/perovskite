...
def gen_fp_file(fp, # List of fingerprint types to use
        A_id, # String containing elemental abbreviation for A metal
        B_id, # String containing elemental abbreviation for B metal
        primary_ads, # String containing elemental abbreviation for
                     # adsorbate atom bound to surface
        target_value, # Adsorption energy; float
        secondary_ads=None # list containing adsorbate atoms not
                           # bound to surface
        ):
