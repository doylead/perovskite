...
dbpath = '../data.db'
commands = [
	"CREATE TABLE experiment (id integer primary key, created numeric, createdby varchar, lastmodified numeric, lastmodifiedby varchar, deleted numeric, deletedby varchar, featuresubsetid integer, model_type varchar, RMSE_train numeric, RMSE_test numeric, architecture varchar, activation_function varchar, learning_rate numeric, regularization numeric, foreign key(featuresubsetid) references feature_featuresubset(featuresubsetid))",
